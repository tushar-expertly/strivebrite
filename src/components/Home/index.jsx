...
function Home() {
  ...
  <div className="container mx-auto text-center">
    <h1 className="text-5xl font-bold">
      Adapt. Excel. Lead. Empower Your Growth with Strivebrite
    </h1>
    <p className="mt-4 text-xl">Stay ahead in the ever-changing world of learning.</p>
    <Link
      to={"/training"}
      className="mt-8 px-6 py-3 bg-white text-teal-600 font-semibold rounded-full shadow-md hover:bg-gray-200 transition duration-300"
    >
      Get Started
    </Link>
  </div>
